...
public class fifthCode extends JFrame  {
private JLabel label1;
private JLabel label2;
fifthCode() throws IOException{
   setLayout(new FlowLayout());
  //image1 = new ImageIcon(getClass().getResource("ICE_logo.jpg")); for jdk old version(8,6 etc)
  File file = new
  File("D:\\Java program\\java_code\\src\\Image\\ICE_logo.jpg");
  ...
  File file2 = new File("D:\\Java program\\java_code\\src\\Image\\Pust_logo.png");
